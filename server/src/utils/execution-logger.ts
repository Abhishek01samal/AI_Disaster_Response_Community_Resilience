...
/**
 * Wraps a single agent's execution in an auditable AgentExecution row:
 * QUEUED -> RUNNING -> SUCCESS/FAILED/REVIEW_REQUIRED, with input/output
 * captured for later inspection. Every agent call in every Inngest function
 * should go through this so the AgentWorkflow's timeline is fully
